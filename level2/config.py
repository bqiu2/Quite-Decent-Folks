...
# Pest roles replace the old zombie roster.  Keep the legacy names below as
# aliases because shared score/tests still use the original Level 2 contract.
PEST_SPAWN_X = WINDOW_WIDTH + 45
PEST_GOAL_X = HOUSE_WIDTH - 5
PEST_SIZE = (92, 84)
PEST_SPAWN_INTERVAL = 0.82

ZOMBIE_SIZE = PEST_SIZE
ZOMBIE_SPEED = 46.0
ZOMBIE_HEALTH = 60.0
ZOMBIE_SPAWN_X = PEST_SPAWN_X
ZOMBIE_GOAL_X = PEST_GOAL_X

WAVE_COUNTS = (6, 10)
SPAWN_INTERVAL = PEST_SPAWN_INTERVAL
