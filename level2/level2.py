...
class Level2Game:
    ...
    def __init__(
        ...
        self.small_font = pygame.font.SysFont("microsoftyahei", 19)
    ...
    def _draw_hud(self) -> None:
        pygame.draw.rect(self.screen, HUD_COLOR, (0, 0, WINDOW_WIDTH, BATTLEFIELD_TOP))
        title = self.font.render("LEVEL 2  |  PLANT GUARDIAN", True, TEXT_COLOR)
        instructions = self.small_font.render(
            "键盘：↑/↓ 或 W/S    H：开启/关闭手势    Esc：退出",
            True,
            TEXT_COLOR,
        )
        ...
        hand_text = self.small_font.render(
            f"摄像头手势：{self._hand_status_text()}",
            True,
        ...
        for lane_index in range(LANE_COUNT):
            ...
            pygame.draw.circle(self.screen, color, (indicator_x + lane_index * 24, 108), 6)
    ...
    def _draw_house(self) -> None:
        ...
        pygame.draw.circle(self.screen, (225, 187, 82), (door.right - 9, door.centery), 4)
    ...
    def _draw_tutorial(self) -> None:
        ...
        pygame.draw.rect(panel, (126, 235, 176), panel.get_rect(), 2, border_radius=10)
        if self.hand_controller.enabled:
            line1 = "摄像头已开启：握起其他手指，只伸出食指"
            line2 = "食指朝上/朝下移动一格；收回或横放后可再次触发"
        else:
            line1 = "按 H 开启摄像头手势控制"
            line2 = "也可以先用 ↑/↓ 或 W/S 移动植物"
